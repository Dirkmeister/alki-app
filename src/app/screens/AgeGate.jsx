  ...
  return (
    <div style={{ ...S.inner, justifyContent: "center", alignItems: "center", textAlign: "center" }}>
      <div style={{ marginBottom: 40 }}>
        <div style={{ width: 64, height: 64, borderRadius: 16, background: "rgba(34,214,138,0.1)", border: `1px solid ${S.accentBorder}`, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px", fontSize: 28 }}>🔒</div>
      ...
      <div style={{ width: "100%", maxWidth: 320 }}>
        <button style={S.btn} onClick={onConfirm}>I am 18 or older</button>
        <button style={{ ...S.btnOutline, marginTop: 12 }} onClick={onDeny}>I am under 18</button>
      </div>
    </div>
  );
}
