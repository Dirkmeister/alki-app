// ─────────────────────────────────────────────────────────────
// ALKI — CORE COMPOUND DATABASE (the original 8)
// ─────────────────────────────────────────────────────────────
// Single source of truth for the 8 founding compounds. Previously
// these lived TWICE — inline in AlkiApp.jsx AND copied into
// data/compounds.js — and the two had drifted (audit item 9). This
// module is the canonical home; data/compounds.js now combines these
// with the 63-compound expansion, and AlkiApp.jsx imports the combined
// list rather than re-declaring the 8.
//
// Pure data. Imports NOTHING from React / Next / DOM / three — it lives
// inside the portability firewall (CLAUDE.md rule 1) so it ports to
// React Native untouched, exactly like compounds-expanded.js.
// ─────────────────────────────────────────────────────────────
export const CORE_COMPOUNDS = [
  ...
  },
  {
    ...
    cycle: "Continuous; ~8 weeks for visible skin changes",
